...
describe('Service Tests', () => {
  describe('Article Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Article(0, 'AAAAAAA', 'AAAAAAA', 0, 0, 0, currentDate, 'image/png', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            dateEnregistrementArticle: currentDate.format(DATE_FORMAT),
          },
          elemDefault
        );
      ...
      it('should create a Article', () => {
        ...
        const expected = Object.assign(
          {
            dateEnregistrementArticle: currentDate,
          },
          returnedFromService
        );
