...
import { ArticleKnownComponent } from './article-known/article-known.component';
...
export class ArticleComponent implements OnInit, OnDestroy {
  ...
  saveArticleModal(): void {
    this.modalSaveData = this.modalService.open(ArticleKnownComponent, { size: 'lg', backdrop: 'static' });
  }
  ...
  viewmodal(article: IArticle): void {
    const viewmodale = this.modalService.open(ArticleDetailComponent, { size: 'lg', backdrop: 'static' });
    viewmodale.componentInstance.article = article;
}
