...
@Component({
  selector: 'jhi-article-known',
  templateUrl: './article-known.component.html',
  styleUrls: ['./article-known.component.scss']
})
export class ArticleKnownComponent implements OnInit {
